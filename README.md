...
> **Note**: If you want to be guided/helped, you already have a file named <a href="IMPROVEMENTS.md">improvements.txt</a> in the project directory, where you can see all the improvements that can be made.
